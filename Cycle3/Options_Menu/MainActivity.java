package com.example.optionsmenu17;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item){
        ...
        if (id==R.id.action_activity_one){
            //Create an Intent to start activity one.
            ...
            startActivity(intent);
            Toast.makeText(this,"Navigating to ActivityTwo",Toast.LENGTH_SHORT).show();
            return true;
        }

        //Pass the selection to the superclass for default handling if no matched are found
